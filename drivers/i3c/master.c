...
struct i3c_device *
i3c_master_create_i3c_device(struct i3c_master_controller *master,
			     u64 pid, u8 dyn_addr)
{
	struct i3c_device_info info = {
		.dyn_addr = dyn_addr,
...
EXPORT_SYMBOL_GPL(i3c_master_create_i3c_device);

void i3c_master_remove_i3c_device(struct i3c_master_controller *master,
				  struct i3c_device *i3c)
{
	struct i3c_dev_desc *i3cdev = i3c->desc;
...
EXPORT_SYMBOL_GPL(i3c_master_remove_i3c_device);
