...
static long npcm750_ece_ioctl(struct file *filp, unsigned int cmd, unsigned long args)
{
	int err = 0;
...
static void npcm750_ece_remove(struct platform_device *pdev)
{
