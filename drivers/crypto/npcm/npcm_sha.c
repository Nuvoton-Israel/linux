...
static struct ahash_alg sha_algs[4] = {
	...
	},
	{
		...
		.halg.base	= {
			.cra_name		= "sha256",
			.cra_driver_name	= "nuvoton_sha256",
			.cra_priority		= 300,
			.cra_flags		= CRYPTO_ALG_TYPE_AHASH | CRYPTO_ALG_ASYNC,
	...
	},
	{
		...
		.halg.base	= {
			.cra_name		= "sha384",
			.cra_driver_name	= "nuvoton_sha384",
			.cra_priority		= 300,
			.cra_flags		= CRYPTO_ALG_TYPE_AHASH | CRYPTO_ALG_ASYNC,
	...
	},
	{
		...
		.halg.base	= {
			.cra_name		= "sha512",
			.cra_driver_name	= "nuvoton_sha512",
			.cra_priority		= 300,
			.cra_flags		= CRYPTO_ALG_TYPE_AHASH | CRYPTO_ALG_ASYNC,
...
static void __exit npcm_sha_remove(struct platform_device *pdev)
{
